...
privileged aspect Media_Roo_DbManaged {
    ...
    private Set<AlbumMedia> Media.albumMedias;
    ...
    public Set<AlbumMedia> Media.getAlbumMedias() {
        return albumMedias;
    }
    
    public void Media.setAlbumMedias(Set<AlbumMedia> albumMedias) {
    ...
    public Clob Media.getLink() {
        return link;
    }
    
    public void Media.setLink(Clob link) {
        this.link = link;
    }
