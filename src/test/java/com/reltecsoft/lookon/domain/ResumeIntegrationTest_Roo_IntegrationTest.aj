...
privileged aspect ResumeIntegrationTest_Roo_IntegrationTest {
    ...
    @Test
    public void ResumeIntegrationTest.testFlush() {
        Resume obj = dod.getRandomResume();
        Assert.assertNotNull("Data on demand for 'Resume' failed to initialize correctly", obj);
        Long id = obj.getId();
        Assert.assertNotNull("Data on demand for 'Resume' failed to provide an identifier", id);
        obj = resumeService.findResume(id);
        Assert.assertNotNull("Find method for 'Resume' illegally returned null for id '" + id + "'", obj);
        boolean modified =  dod.modifyResume(obj);
        Integer currentVersion = obj.getVersion();
        resumeRepository.flush();
        Assert.assertTrue("Version for 'Resume' failed to increment on flush directive", (currentVersion != null && obj.getVersion() > currentVersion) || !modified);
    }
    
    @Test
    public void ResumeIntegrationTest.testUpdateResumeUpdate() {
        Resume obj = dod.getRandomResume();
        Assert.assertNotNull("Data on demand for 'Resume' failed to initialize correctly", obj);
        Long id = obj.getId();
        Assert.assertNotNull("Data on demand for 'Resume' failed to provide an identifier", id);
        ...
        boolean modified =  dod.modifyResume(obj);
        Integer currentVersion = obj.getVersion();
        Resume merged = resumeService.updateResume(obj);
        resumeRepository.flush();
        Assert.assertEquals("Identifier of merged object not the same as identifier of original object", merged.getId(), id);
        Assert.assertTrue("Version for 'Resume' failed to increment on merge and flush directive", (currentVersion != null && obj.getVersion() > currentVersion) || !modified);
    }
