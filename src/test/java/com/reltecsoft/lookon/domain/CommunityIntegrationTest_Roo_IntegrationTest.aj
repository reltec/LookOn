...
privileged aspect CommunityIntegrationTest_Roo_IntegrationTest {
    ...
    @Test
    public void CommunityIntegrationTest.testFlush() {
        Community obj = dod.getRandomCommunity();
        Assert.assertNotNull("Data on demand for 'Community' failed to initialize correctly", obj);
        Long id = obj.getId();
        Assert.assertNotNull("Data on demand for 'Community' failed to provide an identifier", id);
        obj = communityService.findCommunity(id);
        Assert.assertNotNull("Find method for 'Community' illegally returned null for id '" + id + "'", obj);
        boolean modified =  dod.modifyCommunity(obj);
        Integer currentVersion = obj.getVersion();
        communityRepository.flush();
        Assert.assertTrue("Version for 'Community' failed to increment on flush directive", (currentVersion != null && obj.getVersion() > currentVersion) || !modified);
    }
    
    @Test
    public void CommunityIntegrationTest.testUpdateCommunityUpdate() {
        Community obj = dod.getRandomCommunity();
        Assert.assertNotNull("Data on demand for 'Community' failed to initialize correctly", obj);
        Long id = obj.getId();
        Assert.assertNotNull("Data on demand for 'Community' failed to provide an identifier", id);
        ...
        boolean modified =  dod.modifyCommunity(obj);
        Integer currentVersion = obj.getVersion();
        Community merged = communityService.updateCommunity(obj);
        communityRepository.flush();
        Assert.assertEquals("Identifier of merged object not the same as identifier of original object", merged.getId(), id);
        Assert.assertTrue("Version for 'Community' failed to increment on merge and flush directive", (currentVersion != null && obj.getVersion() > currentVersion) || !modified);
    }
